    ...
    return(
        <div>
            <form className={styles.postcreation} onSubmit={(e) => createPostFunction(e, imageUpload) }>
                ...
                <input type="text" id="postContent" name="postContent" className={styles.input} placeholder="write your event caption!"/>

                <label htmlFor="postDate"></label>
                <input type="text" id="postDate" name="postDate" className={styles.input} placeholder="event date(mm/dd/yy)"/>
